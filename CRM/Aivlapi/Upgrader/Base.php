 ...
 */
class CRM_Aivlapi_Upgrader_Base {

  /**
   * @var CRM_Aivlapi_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Aivlapi_Upgrader(
        'be.aivl.aivlapi',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Aivlapi_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Aivlapi_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
